          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={styles.codeBlock}>
                ...
                <Text style={[styles.textXS, styles.monospace]}>nx lint MobileDx3</Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Run them together!
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.marginBottomMd]}>
                  nx run-many -p MobileDx3 -t build test lint
                </Text>
              </View>
              ...
              <View style={[styles.codeBlock, styles.marginBottomLg]}>
                <Text style={[styles.textXS, styles.monospace]}>nx show project MobileDx3</Text>
              </View>
              <View style={styles.listItem}>
                <Svg
                  fill="none"
