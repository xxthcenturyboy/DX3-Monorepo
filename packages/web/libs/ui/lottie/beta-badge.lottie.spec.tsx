...
import { BetaBadgeLottie } from './beta-badge.lottie'
...
describe('BetaBadgeLottie', () => {
  it('should render without crashing', () => {
    const { container } = render(<BetaBadgeLottie />)
    expect(container.firstChild).not.toBeNull()
  })

  it('should render LottieWrapper with correct animation data', () => {
    const { getByTestId } = render(<BetaBadgeLottie />)
    const wrapper = getByTestId('lottie-wrapper')

    expect(wrapper).toHaveAttribute('data-animation-data', '/assets/animations/beta-badge.json')
  })
  ...
  it('should accept complete callback', () => {
    ...
    render(<BetaBadgeLottie complete={mockComplete} />)
