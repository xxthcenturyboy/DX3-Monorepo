...
import { ErrorLottie } from './error.lottie'
...
describe('ErrorLottie', () => {
  it('should render without crashing', () => {
    const { container } = render(<ErrorLottie />)
    expect(container.firstChild).not.toBeNull()
  })

  it('should render LottieWrapper with correct animation data', () => {
    const { getByTestId } = render(<ErrorLottie />)
    const wrapper = getByTestId('lottie-wrapper')

    expect(wrapper).toHaveAttribute('data-animation-data', '/assets/animations/grim-reaper.json')
  })
  ...
  it('should accept complete callback', () => {
    ...
    render(<ErrorLottie complete={mockComplete} />)
