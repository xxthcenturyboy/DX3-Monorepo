...
describe('blogEditorListReducer', () => {
  ...
  describe('filterValueSet', () => {
    it('should set filter value', () => {
      const state = blogEditorListReducer(blogEditorListInitialState,
  ...
  describe('statusSet', () => {
    ...
    it('should clear status with empty string', () => {
      const withStatus = blogEditorListReducer(blogEditorListInitialState,
        blogEditorListActions.statusSet(BLOG_POST_STATUS.PUBLISHED),
      )
      const state = blogEditorListReducer(withStatus,
