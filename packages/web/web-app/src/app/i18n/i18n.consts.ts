...
export const DEFAULT_STRINGS: StringKeys = {
  ...
  ADD: 'Add',
  APP_MENU: 'App Menu',
  ARE_YOU_SURE_YOU_WANT_TO_DELETE_THE_EMAIL:
    'Are you sure you want to delete the email: {email} ({label})?',
  ARE_YOU_SURE_YOU_WANT_TO_DELETE_THE_PHONE:
    'Are you sure you want to delete the phone: {phone} ({label})?',
  ...
  SAVE: 'Save',
  SEND: 'Send',
  SEND_APP_UPDATE: 'Send App Update',
  SEND_APP_UPDATE_TO_ALL_USERS: 'Send App update to all users?',
  SEND_CODE: 'Send Code',
  ...
  VERIFY: 'Verify',
  VERSION: 'Version',
  WE_COULDNT_FIND_WHAT_YOURE_LOOKING_FOR: "We couldn't find what you were looking for.",
  WELCOME_BACK: 'Welcome back, {name}!',
  WRITE: 'Write',
  YOU_ARE_NOT_AUTHORIZED_TO_VIEW_THIS_FEATURE: 'You are not authorized to view this feature.',
