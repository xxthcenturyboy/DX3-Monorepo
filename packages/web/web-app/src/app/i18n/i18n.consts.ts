...
export const DEFAULT_STRINGS: StringKeys = {
  ...
  ADMIN_LOGS_ALL_EVENTS: 'All Events',
  ADMIN_LOGS_ALL_STATUS: 'All',
  ADMIN_LOGS_ERROR: 'Error',
  ADMIN_LOGS_EVENT_TYPE: 'Event Type',
  ...
  ADMIN_METRICS_DATE_RANGE: 'Date Range',
  ADMIN_METRICS_DAU: 'Daily Active Users',
  ADMIN_METRICS_FEATURE_EMAIL_SENT: 'Emails Sent',
  ADMIN_METRICS_FEATURE_MEDIA_UPLOAD: 'Media Uploads',
  ADMIN_METRICS_FEATURE_PROFILE_UPDATE: 'Profile Updates',
  ADMIN_METRICS_FEATURE_SMS_SENT: 'SMS Sent',
  ADMIN_METRICS_FEATURE_SUPPORT_REQUEST: 'Support Requests',
  ADMIN_METRICS_FEATURE_USAGE: 'Feature Usage',
  ADMIN_METRICS_LAST_7_DAYS: 'Last 7 days',
  ADMIN_METRICS_LAST_14_DAYS: 'Last 14 days',
  ADMIN_METRICS_LAST_30_DAYS: 'Last 30 days',
  ADMIN_METRICS_LAST_90_DAYS: 'Last 90 days',
  ADMIN_METRICS_MAU: 'Monthly Active Users',
  ADMIN_METRICS_SIGNUPS_7D: 'Signups (Last 7 Days)',
  ADMIN_METRICS_SIGNUPS_30D: 'Signups (Last 30 Days)',
  ADMIN_METRICS_TITLE: 'Metrics Dashboard',
  ADMIN_METRICS_TOTAL_SIGNUPS: 'Total Signups',
  ADMIN_METRICS_UNAVAILABLE: 'Metrics service is not available. TimescaleDB may not be configured.',
  ADMIN_METRICS_WAU: 'Weekly Active Users',
  ADMINS: 'Admins',
  ...
  ARIA_ACCOUNT_MENU: 'Account menu for current user',
  ARIA_ADD_FEATURE_FLAG: 'Add feature flag',
  ARIA_DRAG_TO_RESIZE: 'Drag to resize',
  ARIA_MENU: 'Menu',
  ARIA_PUBLIC_MENU: 'Public menu',
  ARIA_RESIZE_EDITOR: 'Resize editor',
  ARIA_SHOW_NOTIFICATIONS: 'Show notifications',
  ARIA_USER_EMAILS: 'User emails',
  ARIA_USER_PHONES_TABLE: 'User phones table',
  ARRAY_BUFFERS: 'Array Buffers',
  AUTH_FAILED: 'Authentication failed. Please try again.',
  AUTH_INCOMPLETE_BIOMETRIC: 'Biometric data is incomplete',
  AUTH_INVALID_BIOMETRIC: 'Biometric data is invalid',
  ...
  AUTH_SIGNUP_BAD_PHONE_TYPE: 'This phone cannot be used to create an account.',
  ...
  BLOG: 'Blog',
  BLOG_ANONYMOUS: 'Publish as DX3 Team (anonymous)',
  BLOG_CANONICAL_URL: 'Canonical URL',
  BLOG_CANONICAL_URL_HELPER:
    "Optional. Original post URL if this was first published elsewhere (syndication, guest posts). Leave blank to use this site's blog URL.",
  BLOG_CATEGORIES: 'Categories',
  BLOG_CONTENT: 'Content',
  BLOG_CREATE_NEW_POST: 'Create New Post',
  BLOG_CREATE_POST: 'Create Post',
  BLOG_DATE_CREATED: 'Date',
  BLOG_DATE_PUBLISHED: 'Date Published',
  BLOG_DISCARD_CHANGES_CONFIRM: 'You have unsaved changes. Discard them?',
  BLOG_DOWNLOAD_PDF: 'Download PDF',
  BLOG_EDIT_POST_ID: 'Edit Post {id}',
  BLOG_EDIT_POST_TITLE: 'Edit Post',
  BLOG_EDITOR_COMING_SOON_DESC:
    'Full markdown editor with categories, tags, and scheduling will be added in a follow-up.',
  BLOG_EDITOR_MENU: 'Blog Editor',
  BLOG_EDITOR_TITLE: 'Blog Editor',
  BLOG_EXCERPT: 'Excerpt',
  BLOG_EXCERPT_HELPER: 'Brief summary for cards and SEO. Leave empty to auto-generate.',
  BLOG_FEATURED_IMAGE: 'Featured Image',
  BLOG_FEATURED_IMAGE_CHANGE: 'Change',
  BLOG_FEATURED_IMAGE_REMOVE: 'Remove',
  BLOG_FEATURED_IMAGE_SAVE_FIRST: 'Save the post first to set a featured image.',
  BLOG_FEATURED_IMAGE_SET: 'Set featured image',
  BLOG_IMAGE_UPLOAD_SAVE_POST_FIRST: 'Save the post first to add images.',
  BLOG_INSERT_IMAGE: 'Insert image',
  BLOG_INSERT_PDF: 'Insert PDF',
  BLOG_LOAD_FAILED: 'Failed to load blog posts. Please try again.',
  BLOG_LOADING: 'Loading posts...',
  BLOG_NEW_POST_TITLE: 'New Post',
  BLOG_NO_POSTS: 'No posts yet. Check back soon!',
  BLOG_NO_POSTS_FOUND: 'No posts found.',
  BLOG_PAGE_TITLE: 'Blog',
  BLOG_PDF_UPLOAD_SAVE_POST_FIRST: 'Save the post first to add PDFs.',
  BLOG_POST_NOT_FOUND: 'Post not found',
  BLOG_PUBLISH: 'Publish',
  BLOG_PUBLISH_CONFIRM: 'Are you sure you want to publish this post now?',
  BLOG_PUBLISH_NOW: 'Publish Now',
  BLOG_PUBLISHED_ON: 'Published on {date}',
  BLOG_PUBLISHED_READ_ONLY_BANNER:
    'This post has been published and can no longer be edited. You must unpublish first in order to make any edits.',
  ...
  BLOG_SCHEDULE_IN_YOUR_TZ: 'In your timezone:\n{time}',
  ...
  BLOG_SCHEDULED_TO_POST_ON: 'Scheduled to post on {date}',
  BLOG_SEO_DESCRIPTION: 'SEO Description',
  BLOG_SEO_SECTION: 'SEO',
  BLOG_SEO_TITLE: 'SEO Title',
  BLOG_SETTINGS: 'Post settings',
  BLOG_SETTINGS_BUTTON: 'Settings',
  BLOG_SLUG_HELPER: 'URL path (e.g. my-post-title)',
  ...
  BLOG_TOOLTIP_UNPUBLISH: 'Unpublish post',
  BLOG_TOOLTIP_UNSCHEDULE: 'Unschedule and revert to draft',
  BLOG_UNPUBLISH: 'Unpublish',
  BLOG_UNPUBLISH_CONFIRM: 'Unpublish this post? It will no longer be visible on the public blog.',
  BLOG_UNPUBLISH_TO_EDIT: 'Unpublish to edit.',
  BLOG_UNPUBLISHED_PREVIOUSLY_ON: 'Unpublished (previously published on {date})',
  BLOG_UNSCHEDULE: 'Unschedule',
  BLOG_UNSCHEDULE_CONFIRM: 'Unschedule this post? It will revert to draft.',
  BLOG_UPLOAD_FEATURED_IMAGE: 'Upload Featured Image',
  CANCEL: 'Cancel',
  CANCELING: 'Canceling',
  ...
  CLICK_TO_VIEW_USER: 'Click to view user',
  CLOSE: 'Close',
  COMING_SOON: 'Coming Soon',
  CONFIRM: 'Confirm',
  CONFIRM_PASSWORD: 'Confirm Password',
  CONFIRM_REMOVE_OWN_SUPER_ADMIN:
    'Are you sure you want to remove Super Admin from yourself? You will lose elevated privileges.',
  ...
  IMAGE_EDIT_USE_TOOLBAR: 'Use the image button in the toolbar to add images.',
  ITEMS_SELECTED: '{count} selected',
  LABEL: 'Label',
  LAST_NAME: 'Last Name',
  LINK_EDIT_ANCHOR_TEXT: 'Anchor text',
  LINK_EDIT_ANCHOR_TEXT_PLACEHOLDER: 'Visible link text (in square brackets)',
  LINK_EDIT_COPIED: 'Copied!',
  LINK_EDIT_COPY_TO_CLIPBOARD: 'Copy to clipboard',
  LINK_EDIT_EDIT_LINK: 'Edit link',
  LINK_EDIT_OPEN_IN_NEW: 'Open {url} in new window',
  LINK_EDIT_REMOVE_LINK: 'Remove link',
  LINK_EDIT_TITLE: 'Link title',
  LINK_EDIT_TITLE_PLACEHOLDER: 'Tooltip shown on hover (optional)',
  LINK_EDIT_URL: 'URL',
  LINK_EDIT_URL_PLACEHOLDER: 'Select or paste an URL',
  LOADING: 'Loading...',
  LOG_IN: 'Log In',
  ...
  MEDIA_FILE_SIZE_EXCEEDED: 'File too large. Maximum size is {max}.',
  MEDIA_IMAGE_URL_PLACEHOLDER: 'https://example.com/image.jpg',
  MEDIA_INSERT_FROM_URL: 'Insert from URL',
  MEDIA_INVALID_TYPE: 'Invalid file type. Please upload a supported format.',
  MEDIA_TYPE_FILES: 'files',
  MEDIA_TYPE_IMAGE: 'image',
  MEDIA_TYPE_PDF: 'PDF',
  MEDIA_UPLOAD_CLICK_TO_SELECT: 'Tap to select files',
  MEDIA_UPLOAD_DRAG_OR_CLICK: 'Drag and drop files here, or click to select',
  MEDIA_UPLOAD_DROP_HERE: 'Drop files here...',
  MEDIA_UPLOAD_FAILED: 'File upload failed. Please try again.',
  MEDIA_UPLOAD_FILE_EXCEEDS_SIZE: 'File "{fileName}" exceeds size limit.',
  MEDIA_UPLOAD_FILES_SELECTED: '{count} file(s) selected.',
  MEDIA_UPLOAD_HEADER: 'Upload {mediaType}',
  MEDIA_UPLOAD_MAX_FILES: 'Maximum {maxFiles} files allowed.',
  MEDIA_UPLOAD_UNSUPPORTED_TYPE: 'File "{fileName}" has unsupported type. Allowed: {allowedTypes}.',
  MEDIA_UPLOAD_UP_TO_FILES: 'Up to {maxFiles} file(s). Allowed: {allowedTypes}',
  MESSAGE: 'Message',
  NAME: 'Name',
  ...
  PAGE_TITLE_SSR_HEALTH: 'SSR Health',
  ...
  PHONE_MUST_BE_ABLE_TO_RECEIVE_SMS: 'Phone must be able to receive SMS messages.',
  PHONE_NOT_FOUND: 'Phone number not found.',
  PHONE_VERIFICATION_FAILED: 'Phone verification failed. Please try again.',
  PHONES: 'Phones',
  PING: 'Ping',
  PREVIEW: 'Preview',
  PREVIEW_NOT_PUBLISHED: 'This is a preview. This post is not published yet.',
  PROFILE: 'Profile',
  ...
  SUPPORT: 'Support',
  SUPPORT_ASSIGN_REQUIRED: 'Please assign this request before changing status to In Progress.',
  SUPPORT_BULK_CLOSE: 'Close Selected',
  SUPPORT_BULK_MARK_VIEWED: 'Mark as Viewed',
  SUPPORT_CATEGORY: 'Category',
  SUPPORT_CATEGORY_ISSUE: 'Issue',
  SUPPORT_CATEGORY_NEW_FEATURE: 'New Feature',
  SUPPORT_CATEGORY_OTHER: 'Other',
  SUPPORT_CATEGORY_QUESTION: 'Question',
  SUPPORT_FILTER_ALL_CATEGORIES: 'All Categories',
  SUPPORT_FILTER_ALL_REQUESTS: 'All Requests',
  SUPPORT_FILTER_OPEN_ONLY: 'Open Only',
  SUPPORT_MESSAGE: 'Message',
  SUPPORT_NEW_REQUEST_TOAST: 'New {category}: {subject}',
  SUPPORT_NO_REQUESTS: 'No support requests',
  SUPPORT_NO_USER_REQUESTS: 'No support requests from this user',
  SUPPORT_RATE_LIMIT_EXCEEDED:
    'You are submitting requests too quickly. Please wait a few minutes.',
  SUPPORT_REQUEST_NOT_FOUND: 'Support request not found',
  SUPPORT_REQUEST_REFERENCE: 'Request Reference: {id}',
  SUPPORT_REQUEST_SUBMITTED: 'Your support request has been submitted.',
  SUPPORT_REQUEST_SUBMITTED_SUCCESS: 'Request Submitted Successfully',
  SUPPORT_REQUEST_UPDATED: 'Support request updated.',
  SUPPORT_REQUESTS: 'Support Requests',
  SUPPORT_RETURN_TO_DASHBOARD: 'Return to Dashboard',
  SUPPORT_SEARCH_PLACEHOLDER: 'Search by subject or user...',
  ...
  TIMEZONE: 'Timezone',
  TIMEZONE_DESCRIPTION: 'Your timezone is used for displaying dates and times',
  TIMEZONE_SELECT: 'Select your timezone',
  TIMEZONE_SYSTEM: 'System default',
  TITLE: 'Title',
  ...
  USER_PROFANE_USERNAMES_NOT_ALLOWED: 'Profane usernames are not allowed.',
  USER_STATS: 'User Stats',
  USER_TITLE: 'User: {name}',
  USER_UPDATE_FAILED: 'Failed to update user. Please try again.',
  USER_UPDATED: 'User updated',
  USER_USERNAME_UNAVAILABLE: 'This username is not available',
  USERNAME: 'Username',
