...
export type StringKeys = {
  ...
  ADMIN_METRICS_DATE_RANGE: string
  ADMIN_METRICS_DAU: string
  ADMIN_METRICS_FEATURE_EMAIL_SENT: string
  ADMIN_METRICS_FEATURE_MEDIA_UPLOAD: string
  ADMIN_METRICS_FEATURE_PROFILE_UPDATE: string
  ADMIN_METRICS_FEATURE_SMS_SENT: string
  ADMIN_METRICS_FEATURE_SUPPORT_REQUEST: string
  ADMIN_METRICS_FEATURE_USAGE: string
  ADMIN_METRICS_LAST_7_DAYS: string
  ADMIN_METRICS_LAST_14_DAYS: string
  ADMIN_METRICS_LAST_30_DAYS: string
  ADMIN_METRICS_LAST_90_DAYS: string
  ADMIN_METRICS_MAU: string
  ADMIN_METRICS_SIGNUPS_30D: string
  ADMIN_METRICS_SIGNUPS_7D: string
  ADMIN_METRICS_TITLE: string
  ADMIN_METRICS_TOTAL_SIGNUPS: string
  ...
  BLOG_CANONICAL_URL_HELPER: string
  ...
  BLOG_FEATURED_IMAGE_CHANGE: string
  BLOG_FEATURED_IMAGE_REMOVE: string
  BLOG_FEATURED_IMAGE_SAVE_FIRST: string
  BLOG_FEATURED_IMAGE_SET: string
  BLOG_SEO_DESCRIPTION: string
  BLOG_UPLOAD_FEATURED_IMAGE: string
  ...
  BLOG_SCHEDULE: string
  BLOG_SCHEDULE_DATE: string
  BLOG_SCHEDULE_IN_YOUR_TZ: string
  BLOG_SCHEDULE_POST: string
  BLOG_SCHEDULE_PUBLISH: string
  BLOG_SCHEDULE_TZ_OTHER: string
  BLOG_SCHEDULE_TZ_YOURS: string
  BLOG_SCHEDULE_TIMEZONE: string
